...
for i in range(6):
	result, joint_one_handle = vrep.simxGetObjectHandle(clientID, 'UR3_joint'+str(i+1), vrep.simx_opmode_blocking)
	...
	vrep.simxSetJointTargetPosition(clientID, joint_one_handle, theta + (np.pi / 6), vrep.simx_opmode_oneshot)
